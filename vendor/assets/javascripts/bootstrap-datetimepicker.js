...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.showOnTextFieldClick = options.showOnTextFieldClick == null ? true : options.showOnTextFieldClick;
		this.dateOnly = options.dateOnly == null ? false : options.dateOnly;
