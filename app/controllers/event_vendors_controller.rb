class EventVendorsController < ApplicationController
  ...
  def create
    if params[:event_vendor][:menu_template]
      ...
      current_event.add_replace_menu_template(params[:event_vendor][:menu_template], participation, params[:event_vendor][:white_label_fooda])
  ...
  def update
    ...
    if (@event_vendor.invoiced_line_items? && @event_vendor.menu_template_id.to_s != params[:event_vendor][:menu_template_id])
      ...
      current_event.add_replace_menu_template(params[:event_vendor][:menu_template_id], params[:event_vendor][:participation], params[:event_vendor][:white_label_fooda])
  ...
  def change_grouped_menu_template_selections
    ...
    if (@event_vendor.invoiced_line_items?)
      ...
      if @event_vendor.menu_template.are_selections_valid(params[:item_ids])
        current_event.change_inventory_items_for_vendor(@event_vendor.vendor_id, params[:item_ids])
