#TODO move into several files & remove tags
...
class Setup < ActiveRecord::Migration
  def up
    ...
    create_table :product_types do |t|
      t.string  :name
#      has_many :vendors, :through => :vendor_product_type
#      has_many :vendor_product_types
    ...
    create_table :menu_templates do |t|
      t.string        :name
      # enumeration menu pricing/item pricing (level)
